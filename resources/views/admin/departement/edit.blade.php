@extends('layouts.app')
@section('title', 'Ubah Data Departement')
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.departement.update', $departement->id) }}" method="post"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name='name' value="{{ old('name', $departement->name) }}"
                                        class="form-control @error('name') is-invalid
                                            @enderror"
                                        id="basic-default-fullname" placeholder="Masukkan Nama departement" required>
                                    @error('name')
