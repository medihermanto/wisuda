                ...
                <div class="col-lg-12 mb-4 order-0">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @can('roles.create')
                                <a href="{{ route('admin.role.create') }}" class="btn btn-primary mb-2" type="submit"
                                ...
                                <table class="table table-hover table-striped">
                                    <thead class='table-dark'>
                                        <tr>
                                            ...
                                            <th class="text-white" style="width:15%">Role</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @foreach ($role->getPermissionNames() as $permission)
                                                        <span
                                                            class="badge rounded-pill bg-secondary mb-1">{{ $permission }}</span>
                                                    @endforeach
                                                </td>
